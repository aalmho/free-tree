...
import {StyleSheet, TextInput, View, TouchableWithoutFeedback, Keyboard, Button, Image, Dimensions} from 'react-native';
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
               ...
               <Image style={styles.image} source={{uri: fileUri}} />
                ...
                <TextInput style={styles.input} value={description} onChangeText={setDescription} placeholder="Make a description" />
                <Button
                onPress={submitPost}
                title="Submit"
                />
